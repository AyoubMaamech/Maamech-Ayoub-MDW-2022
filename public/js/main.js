(function ($) {
  ...
  $(function () {
        ...
        scales: {
          ...
          yAxes: [{
            ...
            ticks: {
              ...
              fontColor: "#646464",
              fontSize: 16,
              stepSize: earning_chart_step_size,
              padding: 20,
        ...
        scales: {
          ...
          yAxes: [{
            ...
            ticks: {
              ...
              fontColor: "#646464",
              fontSize: 14,
              stepSize: expense_chart_step_size,
              padding: 20,
              beginAtZero: true,
              callback: function (value) {
                var ranges = [{
    ...
    if ($("#student-doughnut-chart").length) {
      var element = $("#student-doughnut-chart");
      var doughnutChartData = {
        labels: [$(element).attr('data-1-label'), $(element).attr('data-2-label')],
        datasets: [{
          backgroundColor: ["#304ffe", "#ffa601"],
          data: [parseInt($(element).attr('data-1-count')), parseInt($(element).attr('data-2-count'))],
